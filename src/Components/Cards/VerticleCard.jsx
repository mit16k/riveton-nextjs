        ...
        <div className="verticle_card">
            {/* <div className="card verticle_main_card">
                <div className="verticle_card_img_div">
                    ...
                    {ele.property_type && <span className="sell_teg">{translate(ele.property_type)}</span>}
                    {ele?.price &&
                ...
                <div className="card-footer" id="feature_card_footer" style={{ height: validParameters.length > 0 ? "auto" : "120px" }}>
