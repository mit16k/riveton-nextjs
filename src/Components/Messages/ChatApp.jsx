        ...
        try {
            ...
            if (!hasAudioInput) {
                Swal.fire({
                    ...
                    text: 'Please connect a microphone to record audio messages.',
                    icon: 'warning',
            ...
            if (error.name === 'NotAllowedError' || error.name === 'PermissionDeniedError') {
                ...
                Swal.fire({
                    ...
                    text: 'Please allow microphone access to record audio messages. Go to your browser settings to enable the microphone permission.',
                    icon: 'warning',
                    confirmButtonText: 'OK',
                });
            ...
            if (isImage) {
                return (
                    <div className="file-preview">
                        <img src={message.file instanceof File ? URL.createObjectURL(file) : file} alt="File Preview" />
                        {message.message &&
                ...
                return (
                    <div className="file-preview">
                        {file ? (
                            typeof file === 'string' ? (
                                <span onClick={() => window.open(file, '_blank')} className='file_pdf'>
                                    {file.split('/').pop()}
                                </span>
                            ) : (
                                <span onClick={() => window.open(URL.createObjectURL(file), '_blank')} className='file_pdf'>
                                    {file.name}
                                </span>
                            )
                        ) : null}
